...
Sekunden fertig.
    ...
    python3 scripts/karten_zuverlaessigkeit.py              # alle Varianten
    python3 scripts/karten_zuverlaessigkeit.py --frueh 120  # nur eine Schwelle
    python3 scripts/karten_zuverlaessigkeit.py --netz ubahn
...
from src.analysis.karten import (                              # noqa: E402
    anteile_je_haltestelle, lsa_statuskarte, zuverlaessigkeitskarte,
)
